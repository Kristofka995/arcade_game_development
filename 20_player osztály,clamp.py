...
class Player(arcade.Sprite):
    def __init__(self):
        ...
        self.textures.append(arcade.load_texture("my_sprites/greene.png"))
        self.textures.append(arcade.load_texture("my_sprites/greene.png", flipped_horizontally=True))
...
class GameWindow(arcade.Window):
    ...
    def on_update(self, delta_time: float):
        ...
        self.player.center_x = clamp1(self.player.center_x, 25, MAP_WIDTH-TITLE_WIDTH-30)
#following
