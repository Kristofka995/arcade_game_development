...
class GameWindow(arcade.Window):
    def __init__(self, width, height, title):
        ...
        self.girl = arcade.AnimatedTimeBasedSprite("my_sprites/girl.png", image_x=0, image_y=0, image_width=256, image_height=256)
        ...
        # Cat animation
        self.cat = arcade.AnimatedTimeBasedSprite("my_sprites/cat.png", image_x=0, image_y=0,
                                                  image_width=512, image_height=256)

        # loading the frames individually
        # frame 1
        texture = arcade.load_texture("my_sprites/cat.png", x=0, y=0, width=512, height=256)
        self.cat.frames.append(arcade.AnimationKeyframe(tile_id=0, duration=50, texture=texture))

        # frame 2
        texture = arcade.load_texture("my_sprites/cat.png", x=512, y=0, width=512, height=256)
        self.cat.frames.append(arcade.AnimationKeyframe(tile_id=1, duration=50, texture=texture))

        # frame 3
        texture = arcade.load_texture("my_sprites/cat.png", x=0, y=256, width=512, height=256)
        self.cat.frames.append(arcade.AnimationKeyframe(tile_id=2, duration=50, texture=texture))

        # frame 4
        texture = arcade.load_texture("my_sprites/cat.png", x=512, y=256, width=512, height=256)
        self.cat.frames.append(arcade.AnimationKeyframe(tile_id=3, duration=50, texture=texture))

        # frame 5
        texture = arcade.load_texture("my_sprites/cat.png", x=0, y=512, width=512, height=256)
        self.cat.frames.append(arcade.AnimationKeyframe(tile_id=4, duration=50, texture=texture))

        # frame 6
        texture = arcade.load_texture("my_sprites/cat.png", x=512, y=512, width=512, height=256)
        self.cat.frames.append(arcade.AnimationKeyframe(tile_id=5, duration=50, texture=texture))

        # frame 7
        texture = arcade.load_texture("my_sprites/cat.png", x=0, y=768, width=512, height=256)
        self.cat.frames.append(arcade.AnimationKeyframe(tile_id=6, duration=50, texture=texture))

        # frame 8
        texture = arcade.load_texture("my_sprites/cat.png", x=512, y=768, width=512, height=256)
