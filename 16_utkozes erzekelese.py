...
class GameWindow(arcade.Window):
    def __init__(self, witdh, height, title):
        super().__init__(witdh, height, title)
        self.center_window()
        self.background_color = (25, 25, 25, 255)

        self.player1 = arcade.Sprite("my_sprites/playerShip1_green.png", center_x=640, center_y=360)
        self.player2 = arcade.Sprite("my_sprites/playerShip1_green.png", center_x=940, center_y=200)
        self.enemy1 = arcade.Sprite("my_sprites/playerShip1_orange.png", center_x=440, center_y=160)
        self.enemy2 = arcade.Sprite("my_sprites/playerShip2_orange.png", center_x=240, center_y=360)
        self.enemy3 = arcade.Sprite("my_sprites/playerShip3_orange.png", center_x=840, center_y=560)
